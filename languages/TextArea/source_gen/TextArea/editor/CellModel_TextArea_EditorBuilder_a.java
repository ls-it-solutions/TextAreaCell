...
/*package*/ class CellModel_TextArea_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public CellModel_TextArea_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_d1s7jx_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_d1s7jx_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "text area");
    editorCell.setCellId("Constant_d1s7jx_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.propertyDeclaration$Zi0D;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.propertyDeclaration$Zi0D);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.propertyDeclaration$Zi0D);
    }
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_d1s7jx_d0");
    editorCell.setDefaultText("");
    return editorCell;
  }
